export const tickertapeAdvice = [
	...
	"We understand that life happens: use the orange ‘skip’ status to indicate when you missed your habit due to an emergency or a factor outside your control, such as being sick or working late",
