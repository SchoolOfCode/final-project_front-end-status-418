...
const DetailsPanel = ({
  ...
  function setNameAndDesc() {
    if (currentHabitDisplayed) {
      setName(currentHabitDisplayed.name ? currentHabitDisplayed.name : "");
      setDescription(
  ...
  function handleChange(e, input, inputType) {
    ...
    } else throw new Error("Incorrect input type in handle change function");
  }
    ...
    return isEditing ? (
      ...
      >
        ...
        <Input
          ...
          // 	handleChange("name");
          // }}
          onBlur={(e) => handleChange(e, e.currentTarget.value, "name")}
      ...
      <Box className="description">
        ...
        >
          ...
          <EditableTextarea
            ...
            // }}
            onBlur={(e) =>
              handleChange(e, e.currentTarget.value, "description")
            }
          />
        </Editable>
      </Box>
      ...
      <form id="details-form">
        ...
        <Box className="frequency">
          <Stack spacing={1} direction="row" align="baseline">
            ...
            <Editable className="fr-reps-disabled" {...fieldFrRepsProps}>
