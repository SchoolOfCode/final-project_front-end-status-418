  ...
  return (
    <div className="policy">
      ...
      <p>
        ...
        name, email address, the contents of the message, and any other
        ...
        and email address. We use the information we collect in various ways,
        including to:
        <li>
        ...
        <li>
          Rootine follows a standard procedure of using log files. These files
      ...
      <br />
      <p>
        Like any other website, Rootine uses ‘cookies'. These cookies are used
      ...
      <br />
      <p>
        Rootine's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        ...
        participate in, and/or monitor and guide their online activity. Rootine
        ...
        information from our records. If you have any questions about this
