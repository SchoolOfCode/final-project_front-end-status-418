	...
	return (
		<div className="policy">
			<p>
				...
				collected and recorded by Rootine and how we use it. If you have
				...
				they shared and/or collect in Rootine. This policy is not
				applicable to any information collected offline or via channels
				other than this website. Consent By using our website, you
				hereby consent to our Privacy Policy and agree to its terms.
			</p>{" "}
			<p>
				This Privacy Policy has been generated with the Privacy Policy
				Generator which is available from
				https://www.privacypolicygenerator.info/ Information we collect
				...
				website • Improve, personalize, and expand our website •
				Understand and analyze how you use our website • Develop new
				products, services, features, and functionality • Communicate
				...
				• Log Files Rootine follows a standard procedure of using log
			...
			<p>
				Cookies and Web Beacons Like any other website, Rootine uses
			...
			<p>
				DoubleClick DART Cookie Google is one of a third-party vendor on
				our site. It also uses cookies, known as DART cookies, to serve
				ads to our site visitors based upon their visit to
				...
				Privacy Policy for each of the advertising partners of Rootine.
				Third-party ad servers or ad networks uses technologies like
				cookies, JavaScript, or Web Beacons that are used in their
				respective advertisements and links that appear on Rootine,
				which are sent directly to users' browser. They automatically
				receive your IP address when this occurs. These technologies are
				used to measure the effectiveness of their advertising campaigns
				and/or to personalize the advertising content that you see on
				websites that you visit. Note that Rootine has no access to or
				control over these cookies that are used by thirdparty
				advertisers.{" "}
			</p>
			<p>
				Third-Party Privacy Policies Rootine's Privacy Policy does not
				...
				browsers' respective websites. What Are Cookies? CCPA Privacy
				Policy (Do Not Sell My Personal Information) Under the CCPA,
				among other rights, California consumers have the right to: •
			...
			<p>
				GDPR Privacy Policy (Data Protection Rights) We would like to
				make sure you are fully aware of all of your data protection
				rights. Every user is entitled to the following: • The right to
				access – You have the right to request copies of your personal
				data. We may charge you a small fee for this service. • The
				...
				to processing – You have the right to object to our processing
			...
			<p>
				...
				and guide their online activity. Rootine does not knowingly
				...
				promptly remove such information from our records. Questions If
